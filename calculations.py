...
def calculate_global_totals():
    """Calcula os totais globais de todas as vendas."""
    ...
    if vendas_df.empty:
        return {key: 0 for key in [
            'total_vendas', 'total_recebido', 'total_a_receber', 'total_custos', 'total_despesas', 
            'lucro_bruto', 'lucro_liquido', 'percentual_lucro',
            'creditos_realizado', 'creditos_pendente', 'debitos_pago_custos', 
            'debitos_pago_despesas', 'total_pago_geral', 'debitos_pendente_custos', 'debitos_pendente_despesas', 
            'total_a_pagar_geral', 'saldo_realizado', 'balanco_futuro'
